  ...
  return (
    <div id="app">
      <section id="app_container_top">
        <div id="navbar_container">
          <div id="navbar">
            <span id="nav_buttons">
              ...
              <div>
                <span class="nav_buttons">about</span>
                <span class="nav_buttons">become a borrower</span>
                <span class="nav_buttons">become a lender</span>
              </div>
            <span class="nav_buttons">contact us</span>
          </div>
        </div>
        ...
        <header id="app_header">
          ...
          <div id="app_button_container">
            <div class="app_sub_button_container">
              <span class="button">Learn More</span>
            </div>
            <div class="app_sub_button_container" style={{backgroundColor: '#0A357C'}}>
              <Link to="/offers" class="button">Get Started</Link>
            </div>
          </div>
        </header>
      </section>
      ...
      <section id="app_container_bottom">
        <div class="app_container_bottom_header">
          <span>Become a lender</span>
        </div>
        <div class="app_sub_container_bottom">
          <div id="card_container">
            <div class="card">
              <img src={require('../images/users.png')} />
              <span>Borrowers</span>
          ...
          <div id="app_content_bottom">
            <div class="app_info_card">
              <div class="app_info_card_image">
                <img src={require("../images/note.png")} />
              </div>
              <div class="app_info_card_text">
                <span class="app_info_card_header">Accept an exisitng loan request or create one</span>
            ...
            <div class="app_info_card">
              ...
              <div class="app_info_card_text">
                <span class="app_info_card_header">Create a loan request</span>
